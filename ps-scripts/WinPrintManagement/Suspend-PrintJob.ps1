...
.DESCRIPTION
    Suspends a specific print job on the specified printer using the PrintManagement module.
...
.EXAMPLE
    PS> ./Suspend-PrintJob.ps1 -ComputerName "PC01" -PrinterName "MyPrinter" -JobID 5
