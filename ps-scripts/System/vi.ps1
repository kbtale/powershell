...
.SYNOPSIS
	Edit a text file
.DESCRIPTION
	This PowerShell script opens the installed text editor with the given text file. It tries to use neovim, vim, vi, nano, pico, Helix, Emacs, Visual Studio Code, Notepad, Microsoft Edit, or Wordpad (in that order).
.PARAMETER path
