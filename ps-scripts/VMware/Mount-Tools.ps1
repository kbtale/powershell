...
<#
.SYNOPSIS
    VMware: Mounts the VMware Tools CD installer on the guest OS
.DESCRIPTION
    Mounts the VMware Tools installer CD as a CD-ROM on the guest operating system.
.PARAMETER VIServer
...
.EXAMPLE
    PS> ./Mount-Tools.ps1 -VIServer "vcenter.contoso.com" -VICredential $cred -VMName "MyVM"
.CATEGORY VMware
#>
...
Process {
    ...
    try {
        ...
        $null = Mount-Tools -VM $machine -Server $vmServer -ErrorAction Stop
