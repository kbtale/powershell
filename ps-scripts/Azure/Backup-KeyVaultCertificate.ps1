...
.DESCRIPTION
	Downloads a backup of a certificate from an Azure Key Vault to a file.
.PARAMETER VaultName
...
.EXAMPLE
	PS> ./Backup-KeyVaultCertificate.ps1 -VaultName "MyVault" -Name "MyCert" -OutputFile "C:\backup.blob"
.CATEGORY Azure
#>
param(
