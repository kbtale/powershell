...
.DESCRIPTION
    Removes users or groups as members from Azure Active Directory groups using the MSOnline module.
...
.EXAMPLE
    PS> ./Remove-MsOMembersFromGroups.ps1 -TargetGroupNames @("Sales Team") -UserNames @("user@domain.com")
.CATEGORY O365
#>
