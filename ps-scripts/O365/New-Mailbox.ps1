...
.DESCRIPTION
    Creates a new mailbox and associated user account in Exchange Online. Only parameters with values are applied beyond the initial creation.
.PARAMETER Name
...
.EXAMPLE
    PS> ./New-Mailbox.ps1 -Name "JohnDoe" -UserPrincipalName "john@domain.com" -Password (ConvertTo-SecureString "P@ssw0rd" -AsPlainText -Force)
.CATEGORY O365
#>
