...
<#
.SYNOPSIS
    PowerApps: Retrieves connector role assignments
.DESCRIPTION
...
.EXAMPLE
    PS> ./Get-ConnectorRoleAssignment.ps1 -PACredential $cred -AppName "my-app"
.CATEGORY O365
#>
...
Process {
    try {
        ...
        $result = Get-PowerAppConnectorRoleAssignment @getArgs -ErrorAction Stop | Select-Object $Properties
