...
<#
.SYNOPSIS
    PowerApps Admin: Retrieves flow user details
.DESCRIPTION
    Returns user details associated with flows.
...
.PARAMETER ApiVersion
    API version to call
.EXAMPLE
    PS> ./Get-FlowUserDetails.ps1 -PACredential $cred -FlowName "my-flow"
.CATEGORY O365
#>
...
Process {
    try {
        ...
        $result = Get-AdminFlowUserDetails @args -ErrorAction Stop | Select-Object *
