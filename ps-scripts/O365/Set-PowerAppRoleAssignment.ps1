...
<#
.SYNOPSIS
    PowerApps: Sets a PowerApp role assignment
.DESCRIPTION
    Assigns a role to a user/group for a PowerApp.
...
.PARAMETER ApiVersion
    API version to call
.EXAMPLE
    PS> ./Set-PowerAppRoleAssignment.ps1 -PACredential $cred -AppName "my-app" -PrincipalObjectId "guid" -RoleName CanEdit
.CATEGORY O365
#>
