...
.DESCRIPTION
	Adds specified user objects to one or more Active Directory groups.
.PARAMETER OUPath
...
.EXAMPLE
	PS> ./Add-UserToGroup.ps1 -UserNames "jdoe" -GroupNames "VPNUsers,HR" -OUPath "OU=Users,DC=contoso,DC=com"
